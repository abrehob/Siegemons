...
class Inventory(object):
    def __init__(self):
        self.main_hand = MeleeWeapon("pDOG", "Alfred", 1, STARTING_WEAPON_DURABILITY) #MeleeWeapon("SWORD", "Wooden Sword", 2)
        self.offhand = None
        self._MAX_ITEMS = 6
    ...
    def equip_main_hand(self, item):
        ...
        if isinstance(item, RangedWeapon):
            self.main_hand = item
            self.offhand = None
        elif isinstance(item, MeleeWeapon) or isinstance(item, Defense):
    ...
    def get_durability(self):
        return self.main_hand.durability
    
    def get_max_durability(self):
        return self.main_hand.max_durability
    ...
    def get_defense(self):
        ...
        '''
        defense += self.main_hand.strength
        return defense
